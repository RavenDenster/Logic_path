...
func recount_gates():
	...
	print("Recounted gates - AND: ", and_gate_count, ", XOR: ", xor_gate_count, ", OR: ", or_gate_count, ", NOT: ", not_gate_count, ", XNOR: ", xnor_gate_count)
...
func _on_add_xor_button_pressed():
	...
	xor_gate.position = Vector2(600, 500)
	add_child(xor_gate)
...
func _on_add_or_button_pressed():
	...
	or_gate.position = Vector2(600, 700)
	add_child(or_gate)
...
func _on_add_nxor_button_pressed():
	...
	xnor_gate.position = Vector2(600, 800)
	add_child(xnor_gate)
...
func restore_level_state(state):
	...
	print("Level state restored successfully. AND gates: ", and_gate_count, ", XOR gates: ", xor_gate_count, ", OR gates: ", or_gate_count, ", NOT gates: ", not_gate_count, ", XNOR gates: ", xnor_gate_count)
