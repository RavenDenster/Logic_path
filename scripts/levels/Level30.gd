...
func _ready():
	level_data = load("res://data/level_30_data.tres")
	super._ready()

func _on_add_d_flip_flop_button_pressed():
	print("Adding D Flip-Flop in Level30")
	var dff = load("res://scenes/gates/DFlipFlop.tscn").instantiate()
...
func _on_add_clk_button_pressed():
	...
	var clk = load("res://scenes/gates/CLKGate.tscn").instantiate()
