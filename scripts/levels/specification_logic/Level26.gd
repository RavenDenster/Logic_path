...
func restore_level_state(state):
	...
	print("Level state restored successfully. AND gates: ", and_gate_count, 
		  ", OR gates: ", or_gate_count, ", NOT gates: ", not_gate_count)
...
func remove_xor_gate():
	print("remove_xor_gate called on Level26 (not used)")

func remove_xnor_gate():
	print("remove_xnor_gate called on Level26 (not used)")

func remove_nand_gate():
	print("remove_nand_gate called on Level26 (not used)")

func remove_nor_gate():
	print("remove_nor_gate called on Level26 (not used)")

func remove_sel0_gate():
	print("remove_sel0_gate called on Level26 (not used)")

func remove_sel1_gate():
	print("remove_sel1_gate called on Level26 (not used)")
