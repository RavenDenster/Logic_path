...
func _ready():
	level_data = load("res://data/level_10_data.tres")
	super._ready()
	recount_gates()
...
func remove_xor_gate():
	print("remove_xor_gate called on Level10 (not used)")

func remove_xnor_gate():
	print("remove_xnor_gate called on Level10 (not used)")

func remove_nand_gate():
	print("remove_nand_gate called on Level10 (not used)")

func remove_nor_gate():
	print("remove_nor_gate called on Level10 (not used)")
...
func clear_level():
	...
	not_gate_count = 0
	update_gate_buttons_state()
	print("Level10 cleared - AND gate count reset to 0, OR gate count reset to 0, NOT gate count reset to 0")
