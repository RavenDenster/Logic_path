...
func _on_area_mouse_entered():
	print("InputBlockR mouse entered")
	_highlight_input_label()

func _on_area_mouse_exited():
	print("InputBlockR mouse exited")
...
func _highlight_input_label():
	...
	if panel and panel.has_method("highlight_labels"):
		print("Found TestResultsPanelRS, highlighting label 0 (Input R)")
		panel.highlight_labels([0])  # Индекс 0 = "Input R"
	else:
